                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget rounded">
                            ...
                            <div class="widget-content">
                                ...
                                <a href="/recherche?search={{ $tag }}" class="tag">{{ $tag }}</a>
                                @endforeach
                                ...
                                <div class="post post-list-sm circle">
                                    <div class="thumb circle">
                                        ...
                                        <a href="/articles/{{ $art->code }}">
                                            <div class="inner">
                                                <img src="{{ asset(Storage::url($art->url_image)) }}" alt="post-title" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="details clearfix">
                                        <h6 class="post-title my-0"><a href="/articles/{{ $art->code }}">{{ $art->titre }}</a></h6>
